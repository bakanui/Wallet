package com.vct.wallet.adapters;
...
public class BaseExpenseAdapter<VH extends RecyclerView.ViewHolder> extends BaseExpenseRecyclerViewAdapter<BaseExpenseAdapter.BaseExpenseViewHolder> {
    ...
    public BaseExpenseAdapter(Context context, BaseViewHolder.RecyclerClickListener onRecyclerClickListener) {
        ...
        this.colorExpense = Wallet.getContext().getResources().getColor(R.color.colorAccentRed);
        this.colorIncome = Wallet.getContext().getResources().getColor(R.color.colorAccentGreen);
        this.prefixExpense = Wallet.getContext().getResources().getString(R.string.expense_prefix);
        this.prefixIncome = Wallet.getContext().getResources().getString(R.string.income_prefix);
        this.titleTransitionName = Wallet.getContext().getString(R.string.tv_title_transition);
    }
    ...
    protected void setAnimation(BaseExpenseViewHolder holder, int position) {
        if (position > lastPosition) {
            Animation animation = AnimationUtils.loadAnimation(Wallet.getContext(), R.anim.push_left_in);
