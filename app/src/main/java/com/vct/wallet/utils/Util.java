...
public class Util {
    ...
    public static String getFormattedCurrency(float number) {
        String countryCode = PreferenceManager.getDefaultSharedPreferences(Wallet.getContext()).getString(Wallet.getContext().getString(R.string.pref_country_key), Wallet.getContext().getString(R.string.default_country));
    ...
    public static String getCurrentDateFormat() {
        return PreferenceManager.getDefaultSharedPreferences(Wallet.getContext()).getString(Wallet.getContext().getString(R.string.date_format_key), Wallet.getContext().getString(R.string.default_date_format));
    }
